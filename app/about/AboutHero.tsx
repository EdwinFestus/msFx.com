...
const AboutHero = () => {
  return (
    <section className='flex flex-col justify-center container mx-auto py-52 lg:py-52 w-full items-center text-center  px-4 h-[Z0vh] lg:h-[70vh] text-white relative'>
