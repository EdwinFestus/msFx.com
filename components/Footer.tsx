...
function Footer() {
    return (
        // <footer classNameName="bg-gray-900 text-white py-10">
        //     <div classNameName="container mx-auto text-center">
        //         <p>&copy; 2022 MastermindFx. All rights reserved.</p>
        //     </div>
        // </footer>
            ...
            <div className="container px-6 py-12 mx-auto">
                <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 sm:gap-y-10 lg:grid-cols-4">
                    <div className="sm:col-span-2">
                        <h1 className="max-w-lg text-xl font-semibold tracking-tight text-gray-800 xl:text-2xl dark:text-white">Subscribe to our newsletter and get updates.</h1>
